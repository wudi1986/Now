        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case SCAN_OK:
                    ...
                    adapter = new GroupAdapter(PhotoActivity.this, list = subGroupOfImage(mGruopMap), mGroupGridView);
...
//		});
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if(requestCode==111&&resultCode==222){
            List<String> filenames= (List<String>) data.getSerializableExtra(ShowImageActivity.SELECTIAMGE);
            Intent intent=new Intent();
            intent.putExtra(ShowImageActivity.SELECTIAMGE, (java.io.Serializable) filenames);
