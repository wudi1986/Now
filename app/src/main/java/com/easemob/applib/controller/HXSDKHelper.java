...
public abstract class HXSDKHelper {
    ...
    public synchronized boolean onInit(Context context){
        ...
        Log.i(  TAG, "initialize EMChat SDK");
    ...
    protected void initHXOptions(){
        Log.i(  TAG, "init HuanXin Options");
        ...
        while (i.hasNext()) {
            ...
            try {
                if (info.pid == pID) {
                    ...
                    // Log.i(  "Process", "Id: "+ info.pid +" ProcessName: "+
                ...
                // Log.i(  "Process", "Error>> :"+ e.toString());
            }
        }
        return processName;
    }
