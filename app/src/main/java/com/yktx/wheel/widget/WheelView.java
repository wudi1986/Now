...
public class WheelView extends View {
	...
	private static final int ADDITIONAL_ITEM_HEIGHT = (int) (20 * BaseActivity.DENSITY);
	...
	private static final int ADDITIONAL_ITEMS_SPACE = (int) (10 * BaseActivity.DENSITY);

	/** Label offset */
	private static final int LABEL_OFFSET = (int) (10 * BaseActivity.DENSITY);

	/** Left and right padding value */
	private static final int PADDING = (int) (50 * BaseActivity.DENSITY);
	...
	private void initData(Context context) {
		TEXT_SIZE = (int) getResources().getDimension(R.dimen.font4);
		ITEM_OFFSET = -TEXT_SIZE / 4;
		VALUE_TEXT_COLOR = getResources().getColor(R.color.meibao_color_3);
		ITEMS_TEXT_COLOR = getResources().getColor(R.color.meibao_color_6);
	...
	private void drawValue(Canvas canvas) {
		...
		valuePaint.setTextSize(getResources().getDimension(R.dimen.font3));
	...
	private void drawItems(Canvas canvas) {
		...
		itemsPaint.setTextSize(getResources().getDimension(R.dimen.font4));
	...
	public void onClick(WheelOnClick onClick) {
		this.onClick = onClick;
	}

	public WheelOnClick onClick;

	public interface WheelOnClick {
		public void onClick();
	};
}
