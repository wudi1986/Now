 ...
 */
package com.yktx.chatuidemo.utils;
...
public class CameraHelper implements PreviewCallback {
    ...
    boolean isScreenOriatationPortrait() {
        return GroupApplication.applicationContext.getResources().getConfiguration().orientation == Configuration.ORIENTATION_PORTRAIT;
    }
}
