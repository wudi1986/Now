...
public class VoicePlayClickListener implements View.OnClickListener {
	...
	public void stopPlayVoice() {
		...
		isPlaying = false;
		((ChatEasemobActivity) activity).playMsgId = null;
	...
	public void playVoice(String filePath) {
		...
		((ChatEasemobActivity) activity).playMsgId = message.getMsgId();
	...
	public void onClick(View v) {
		...
		if (isPlaying) {
			if (((ChatEasemobActivity) activity).playMsgId != null && ((ChatEasemobActivity) activity).playMsgId.equals(message.getMsgId())) {
