...
public class ChatAllHistoryAdapter extends ArrayAdapter<EMConversation> {
	...
	HashMap<String, UserInfoBean> map;
	...
	public void setMap(HashMap<String, UserInfoBean> map) {
		this.map = map;
	}
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (username.equals(Contanst.GROUP_USERNAME)) {
			holder.name.setText("群聊");

		} else if (username.equals(Contanst.NEW_FRIENDS_USERNAME)) {
			holder.name.setText("申请与通知");
		}
		// holder.name.setText(username);
		try {
			if (map != null && username != null && map.get(username) != null) {
				holder.name.setText(map.get(username).getName());
				ImageLoader.getInstance().displayImage(
						UrlParams.IP + map.get(username).getPhoto(),
