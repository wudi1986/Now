...
public class PagerSlidingTabStrip extends HorizontalScrollView {
	...
	private int indicatorColor = getResources().getColor(R.color.meibao_color_6);
	// private int underlineColor = 0x1A000000;
	private int underlineColor = getResources().getColor(R.color.meibao_color_6);
	...
	private int tabTextColor = getResources().getColor(R.color.meibao_color_6);
	private int selectedTabTextColor = getResources().getColor(
	...
	private void updateTabStyles() {
		...
		for (int i = 0; i < tabCount; i++) {
			...
			if (v instanceof TextView) {
				...
				View tabView = ((RelativeLayout) v).getChildAt(0);
				Log.i(  "aaa", "tabViewtabViewtabView");
				if (tabView instanceof TextView) {

					Log.i(  "aaa", "tabView instanceof TextView");
...
//			((TextView) currentTab).setTextSize(16);
//		}
