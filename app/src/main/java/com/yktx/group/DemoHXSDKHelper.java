    ...
    protected OnNotificationClickListener getNotificationClickListener(){
        return new OnNotificationClickListener() {
            ...
            public Intent onNotificationClick(EMMessage message) {
                Intent intent = new Intent(appContext, ChatEasemobActivity.class);
                ...
                if (chatType == ChatType.Chat) { // 单聊信息
                    ...
                    intent.putExtra("chatType", ChatEasemobActivity.CHATTYPE_GROUP);
                }
                return intent;
            }
        };
...
//    	Intent intent = new Intent(appContext, MainActivity.class);
//        intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
//        intent.putExtra(Contanst.ACCOUNT_REMOVED, true);
//        appContext.startActivity(intent);
    }
