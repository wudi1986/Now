...
import com.yktx.chatuidemo.utils.ImageUtils;
import com.yktx.chatuidemo.utils.SmileUtils;
import com.yktx.group.adapter.ExpressionAdapter;
import com.yktx.group.adapter.ExpressionPagerAdapter;
import com.yktx.group.adapter.MessageAdapter;
import com.yktx.group.adapter.VoicePlayClickListener;
 ...
 * 
 */
public class ChatEasemobActivity extends BaseActivity implements OnClickListener  , ServiceListener{
	...
	public static final int REQUEST_CLIP_PHOTO = 26;
	...
	public static ChatEasemobActivity activityInstance = null;
	// 给谁发送消息
...
//	private EMGroup group;
	...
	protected void initView() {
		...
		RelativeLayout rl_leftImage = (RelativeLayout)findViewById(R.id.rl_leftImage);
		rl_leftImage.setOnClickListener(new View.OnClickListener() {
			
			@Override
			public void onClick(View arg0) {
				// TODO Auto-generated method stub
				ChatEasemobActivity.this.finish();
			}
		});
	}
	...
	private void setUpView() {
		...
		if (chatType == CHATTYPE_SINGLE) { // 单聊
			...
			myUserName = getIntent().getStringExtra("myNickName");
			myHead = getIntent().getStringExtra("myHead");

			connGetUserInfo(toChatUsername, getIntent().getStringExtra("myUserID"));
...
//		EMGroupManager.getInstance().addGroupChangeListener(groupListener);
	...
	private void connGetUserInfo(String toChatUsername, String myUserID) {
		
		
		List<NameValuePair> params = new ArrayList<NameValuePair>();
		try {
			params.add(new BasicNameValuePair("bruser_id", toChatUsername));
			params.add(new BasicNameValuePair("myuser_id", myUserID));
		} catch (Exception e) {

		}
		Service.getService(Contanst.HTTP_GETUSERINFO, null, null,
				ChatEasemobActivity.this).addList(params)
		...
		if (resultCode == RESULT_OK) { // 清空消息
			if (requestCode == REQUEST_CODE_EMPTY_HISTORY) {
				...
				try {
					...
					if (bitmap == null) {
						EMLog.i(  "chatactivity", "problem load video thumbnail bitmap,use default icon");
...
//			// 点击摄像图标
//			Intent intent = new Intent(ChatEasemobActivity.this, ImageGridActivity.class);
...
//			else
//				startActivity(new Intent(ChatEasemobActivity.this, VoiceCallActivity.class).putExtra("username", toChatUsername)
...
//                        .putExtra("isComingCall", false));
	...
	public void selectPicFromCamera() {
		...
		cameraFile = new File(PathUtil.getInstance().getImagePath(), GroupApplication.getInstance().getUserName()
...
//				REQUEST_CODE_EMPTY_HISTORY);
		...
		Intent in = new Intent(ChatEasemobActivity.this,
				UserCenterActivity.class);
		in.putExtra("userID", toChatUsername);
		ChatEasemobActivity.this.startActivity(in);
	}
		...
		public boolean onTouch(View v, MotionEvent event) {
			...
			case MotionEvent.ACTION_DOWN:
				if (!CommonUtils.isExitsSdcard()) {
					...
					Toast.makeText(ChatEasemobActivity.this, st4, Toast.LENGTH_SHORT).show();
					return false;
				}
				try {
					v.setPressed(true);
					...
					Toast.makeText(ChatEasemobActivity.this, R.string.recoding_fail, Toast.LENGTH_SHORT).show();
					return false;
				}
			...
			case MotionEvent.ACTION_UP:
				...
				if (event.getY() < 0) {
					...
					try {
						...
						e.printStackTrace();
						Toast.makeText(ChatEasemobActivity.this, st3, Toast.LENGTH_SHORT).show();
					}
				...
				try {
					...
					if (buttonSetModeKeyboard.getVisibility() != View.VISIBLE) {
						...
						if (filename != "delete_expression") { // 不是删除键，显示表情
							...
							Class clz = Class.forName("com.yktx.chatuidemo.utils.SmileUtils");
							Field field = clz.getField(filename);
							mEditTextContent.append(SmileUtils.getSmiledText(ChatEasemobActivity.this, (String) field.get(null)));
						} else { // 删除文字或者表情
							if (!TextUtils.isEmpty(mEditTextContent.getText())) {
...
//						Toast.makeText(ChatEasemobActivity.this, st13, 1).show();
...
//				public void run() {
//					if (toChatUsername.equals(groupId)) {
//						Toast.makeText(ChatEasemobActivity.this, st14, 1).show();
//						if (GroupDetailsActivity.instance != null)
//							GroupDetailsActivity.instance.finish();
//						finish();
//					}
		...
		public void handleMessage(Message msg) {
			...
			case Contanst.BEST_INFO_OK:
				...
				if (msg.arg1 == Contanst.GETUSERINFO) {
					...
					((TextView) findViewById(R.id.name)).setText(userBean.getName());
					adapter.setOtherHead(UrlParams.IP + userBean.getPhoto());
					adapter.notifyDataSetChanged();
				}
				break;
